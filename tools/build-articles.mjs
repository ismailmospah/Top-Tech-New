/* ============================================================
   ...
   from tools/content/articles/*.mjs.
...
const articlePath = (lang, slug) => (lang === "ar" ? `/ar/articles/${slug}` : `/articles/${slug}`);
const indexPath = (lang) => (lang === "ar" ? "/ar/articles" : "/articles");
